    ...
    <section className="mx-auto w-full max-w-7xl px-5 py-16 md:px-10 md:py-20">
      ...
      <div className="text-center mb-12">
        ...
        <div className="my-10 md:my-20 flex flex-col md:flex-row justify-center gap-3">
          {
            blog_nav && blog_nav.map(nav => (<Link href={nav.url} key={nav.url} className="px-4 py-2 bg-fd-primary text-fd-primary-foreground font-semibold rounded-full">
              {nav.name}
            </Link>
            ))
          }
